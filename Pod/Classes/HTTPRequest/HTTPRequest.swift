...
class HTTPRequest : NSObject , NSURLSessionDelegate{
    ...
    private func send(urlRequest urlRequest : NSMutableURLRequest!, successCompletionHandler : successCompletionBlock, failedCompletionHandler : failedCompletionBlock,  returnData : CirrenaModelData.Type!, returnParameters : [String : AnyObject]?){
                    ...
                    do {
                        ...
                        if let jsonDictionary  = jsonObject as? NSDictionary {
                            if let parameters = returnParameters{
                                let instance = returnData.init(dictionary: parameters)
    ...
    class func send(httpMethod : String="POST")
        (returnParameters :  [String : AnyObject]?, urlRequest : NSMutableURLRequest!,
        ...
        myService.send(urlRequest: urlRequest, successCompletionHandler: successCompletionHandler,
            failedCompletionHandler: failedCompletionHandler, returnData: returnData,
